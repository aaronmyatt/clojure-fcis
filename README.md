...
- **Adapter** (`.clj` / `.cljs`) — Side-effectful code: file I/O on JVM, in-memory storage in the browser. Platform-specific implementations, same API.
...
| **Adapter** | `.clj` — file-based storage | `.cljs` — atom-based in-memory storage |
